...
function preload() \{\
  ...
  table = loadTable('music6.csv', 'csv', 'header');\
\}\
\
function setup() \{\
...
\
  ...
  timeMatchedSong = temporalTrack.get('Track Name') || "Row #" + closestIndex;\
  \
  let timeEnergy = float(temporalTrack.get('Energy')) || 0.5;\
  let timeLoudness = abs(float(temporalTrack.get('Loudness'))) || 10;\
\
